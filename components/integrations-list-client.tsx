...
// Как часто дёргать список с сервера. 5 сек — совпадает с интервалом
// heartbeat воркера + backend timeout 30 сек, значит max задержка ~35 сек
// от реального события до отображения. Меньше делать не имеет смысла —
// heartbeat всё равно раз в 5 сек.
