  ...
  return (
    <div ref={searchRef} className={cn("relative w-full", className)}>
      <div className="relative">
           ...
           className="w-full pl-10 pr-10 rounded-lg focus:outline-none focus:ring-0 focus:border-0"
           style={{ 
                          ...
                          >
                           ...
                           {product.brand && typeof product.brand === 'string' && product.brand !== 'no' ? (
                             <Link
                               ...
                               className="block"
                             >
                               <p className="text-xs text-gray-600 hover:text-brand-yellow transition-colors truncate max-w-[100px]">
                                 {product.brand}
                               </p>
                             </Link>
                           ) : (
